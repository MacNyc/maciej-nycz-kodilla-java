...
public class TaskListDaoTestSuite {
    ...
    public void testNamedQueries() {
        ...
        //Then
        try {
            Assert.assertEquals(1, longTasks.size(),20);
            Assert.assertEquals(3, shortTasks.size(),20);
            Assert.assertEquals(3, enoughTimeTasks.size(),20);
            Assert.assertEquals(2, durationLongerThanTasks.size(),20);
        } finally {
            //CleanUp
            taskListDao.delete(id);
        }
